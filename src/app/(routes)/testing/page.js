...
export const metadata = {
  ...
  keywords:
    "SAP Certification Courses, SAP Course, Data Science Course, Power BI Course, Digital Marketing Course, HR Training Institute, SAP Training Institute, Python Course, Software Course, Training, Education",
  author: "Connecting Dots ERP | Software and SAP Training Institute",
  openGraph: {
    title: "Connecting Dots ERP | SAP Training Institute In Pune",
    description:
      "Expert-led training in SAP, Software Development, Digital Marketing, and HR Courses with strong placement support.",
    type: "website",
  },
  twitter: {
    ...
    title: "Connecting Dots ERP | SAP Training Institute In Pune",
    description:
      "Expert-led training in SAP, Software Development, Digital Marketing, and HR Courses.",
  },
};
