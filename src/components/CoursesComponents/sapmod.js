...
// SapModComponent receives data prop directly from parent (similar to first code pattern)
const SapModComponent = ({ data }) => {
  ...
  return (
    <div className="min-h-screen mb-3 bg-[#2d2d2d] flex flex-col items-center py-4 sm:py-8 px-2 sm:px-4">
      {/* Header */}
      <div className="w-full max-w-6xl mb-4 sm:mb-8">
        <h1
      ...
      <div className="flex flex-col md:flex-row gap-4 sm:gap-8 w-full max-w-6xl items-start h-full">
        {/* Left Card */}
        <div
          className="group bg-[#162e5b] rounded-lg p-4 sm:p-8 flex flex-col gap-4 sm:gap-6 w-full md:w-96 text-white shadow-lg h-full justify-start relative overflow-hidden min-h-0 sm:min-h-[600px]"
          style={{ marginTop: 0 }}
        >
          ...
          <div className="relative z-10 flex flex-col gap-4">
            ...
            <button
              ...
              className="mt-4 font-bold rounded-full py-2 px-6 transition-all duration-200 items-center justify-center gap-2 text-base hidden sm:flex shadow-lg border-0 bg-[#091327] text-blue hover:bg-white hover:text-[#0d1e3a]"
            ...
            {/* Note master */}
            {data.noteMaster && (
              <p className="text-red-300 text-center text-sm mt-2">{data.noteMaster}</p>
            )}
          </div>
        </div>
        ...
        <div
          className="flex-1 w-full max-w-3xl relative h-full overflow-visible"
          style={{ minHeight: "100%" }}
        >
          <div className="relative z-10 flex flex-col px-1 sm:px-0">
            {curriculum.map((mod, idx) => (
              ...
              >
                ...
                <div
                  className="absolute -left-0.5 top-0.5 w-full bg-[#4b79d2] rounded-xl z-10 shadow-lg"
                  style={{
                    height: "calc(70% - 2px)",
                ...
                {/* Module Card */}
                <div
                  className="flex-1 bg-white rounded-[10px] shadow transition-all relative z-20"
                ...
                >
                  <div className="flex items-center justify-between px-2 sm:px-4 py-2 cursor-pointer select-none relative">
                    <div className="flex items-center gap-1 sm:gap-2 flex-1 min-w-0">
                      ...
                      <span className="font-semibold text-gray-900 text-sm sm:text-base truncate relative">
                        ...
                        {hoveredModuleIdx === idx &&
                          mod.topics &&
                          mod.topics.length > 0 && (
                            <div className="absolute left-0 top-full z-50 mt-2 w-80 bg-white text-black rounded-lg shadow-2xl p-4 border border-gray-200">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
                      <span className="text-xs text-white-700 font-semibold flex items-center gap-1">
                        <svg
                          width="14"
                          height="14"
        ...
        <div className="flex sm:hidden w-full justify-center items-center mt-1 mb-8">
          <button
            onClick={handleDownloadBrochureClick}
            className="font-bold rounded-full py-2 px-6 transition-all duration-200 flex items-center justify-center gap-2 text-base mx-auto shadow-lg border-0 bg-[#091327] text-white hover:bg-white hover:text-[#091327]"
            style={{ boxShadow: "0 4px 16px 0 rgba(0,0,0,0.18)" }}
          >
            Download Brochure
            <svg
