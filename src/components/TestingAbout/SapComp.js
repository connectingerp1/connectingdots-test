...
const INDUSTRIES_DATA = [
  { name: 'Manufacturing', percentage: 92, color: 'from-orange-400 to-purple-600', description: 'Leading in digital transformation with comprehensive ERP solutions' },
  { name: 'IT & Consulting', percentage: 89, color: 'from-blue-400 to-purple-600', description: 'High adoption driving client implementations and services' },
  { name: 'Retail & FMCG', percentage: 78, color: 'from-green-400 to-blue-600', description: 'Streamlining supply chain and customer experience' },
  { name: 'Banking & Finance', percentage: 85, color: 'from-purple-400 to-pink-600', description: 'Regulatory compliance and risk management solutions' },
  { name: 'Healthcare', percentage: 71, color: 'from-cyan-400 to-blue-600', description: 'Patient data management and operational efficiency' }
];
...
const CircularProgress = React.memo(({ industryName, percentage, index, isVisible, isMobile = false }) => {
  ...
  const desktopColors = DESKTOP_COLORS[industryName] || { start: '#f97316', end: '#9333ea' };
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
          <div 
            ...
            style={isMobile ? { textShadow: '1px 1px 2px rgba(255,255,255,0.8)' } : {}}
          >
            {animatedPercentage}%
          </div>
          <div 
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed px-4">
            The SAP ecosystem continues to dominate the ERP market, with over 400,000 customers worldwide 
            and a growing demand for skilled professionals. At Connecting Dots ERP, we focus on high-demand 
            SAP modules that offer excellent career growth potential.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-xl">
          <p className="text-gray-600 leading-relaxed mb-6 text-sm md:text-base">
            Our training programs are continuously updated to align with the latest SAP innovations, 
            including S/4HANA, SAP Cloud Platform, and industry-specific solutions. With over 10 years 
            of experience in SAP training, we've developed partnerships with leading implementation 
